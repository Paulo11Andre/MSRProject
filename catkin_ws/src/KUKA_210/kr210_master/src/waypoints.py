...
pose_target = geometry_msgs.msg.Pose()
pose_target.orientation.w = 1.0
pose_target.position.x = 1.3
pose_target.position.y = -2.4
pose_target.position.z = 1.8

waypoints.append(copy.deepcopy(pose_target))

pose_target = geometry_msgs.msg.Pose()
pose_target.orientation.w = 1.0
pose_target.position.x = -1.4
pose_target.position.y = -2.0
